  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
           <!-- <form role="form" method="post"  action="<?=site_url(ADMIN_PATH.'/page/edit/'.$info['id'])?>" enctype="multipart/form-data"> -->
             <?php echo form_open_multipart((ADMIN_PATH.'/page/edit/'.$info['id']), '' )?>
            <div class="col-md-12">
