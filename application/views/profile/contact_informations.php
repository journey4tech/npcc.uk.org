                ...
                <div class="row-custom">
                    <div class="profile-tab-content">
                           ...
                           <!--  <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12 col-sm-6 m-b-sm-15">
                                    <input type="text" name="address" class="form-control form-input" value="<?php echo html_escape($user->address); ?>" placeholder="address">
                                </div>

                                <div class="col-12 col-sm-3">
                                    <input type="text" name="zip_code" class="form-control form-input" value="<?php echo html_escape($user->zip_code); ?>" placeholder="zip_code">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone_number" class="form-control form-input" value="<?php echo html_escape($user->phone_number); ?>" placeholder="phone number">
                        </div>
                        <div class="form-group m-t-15">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="checkbox_show_email" class="custom-control-label">Show my email address</label>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="checkbox_show_phone" class="custom-control-label">Show my phone number</label>
                            </div>
                        </div>
                        <div class="form-group m-b-30">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label for="checkbox_show_location" class="custom-control-label">Show my location</label>
                            </div>
                        </div>
