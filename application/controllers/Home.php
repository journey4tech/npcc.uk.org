...
class Home extends CI_Controller
{
    ...
    {
    	$data['category_name'] =$this->Category_model->get_category_name_by_id($id);
	...
	{
		$data['main'] = 'page/about_us';
		$data['info'] = $this->Page_model->get_info($id = 2);
		$this->load->view('index', $data);
	}
	...
	public function contact_us()
	{
		...
		//$data['info'] = $this->Cms_model->get_cms($id = 2);
		$this->load->view('index', $data);
	}
